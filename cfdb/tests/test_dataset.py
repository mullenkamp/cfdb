...
ind_file_path = script_path.joinpath('test_ind.cfdb')
...
def test_dataset_repr_closed():
    ...
    fp = script_path.joinpath('test_closed.cfdb')
...
def test_dataset_context_manager():
    ...
    fp = script_path.joinpath('test_ctx.cfdb')
...
def test_attributes_write():
    ...
    fp = script_path.joinpath('test_attrs.cfdb')
    with open_dataset(fp, flag='n') as ds:
...
def test_attributes_read_only():
    ...
    fp = script_path.joinpath('test_attrs_ro.cfdb')
    with open_dataset(fp, flag='n') as ds:
        ds.create.coord.lat(data=ind_lat_data[:10], chunk_shape=(10,))
...
def test_attributes_non_serializable():
    ...
    fp = script_path.joinpath('test_attrs_ns.cfdb')
    with open_dataset(fp, flag='n') as ds:
        ds.create.coord.lat(data=ind_lat_data[:10], chunk_shape=(10,))
        with pytest.raises(ValueError):
...
def test_coordinate_append():
    ...
    fp = script_path.joinpath('test_append.cfdb')
...
def test_coordinate_prepend():
    ...
    fp = script_path.joinpath('test_prepend.cfdb')
...
def test_data_var_set_method():
    ...
    fp = script_path.joinpath('test_set.cfdb')
...
def test_delete_variable():
    ...
    fp = script_path.joinpath('test_del.cfdb')
...
def test_delete_coord_with_data_var_raises():
    ...
    fp = script_path.joinpath('test_del2.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
    lon = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_lz4_compression():
    ...
    fp = script_path.joinpath('test_lz4.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_zstd_compression():
    ...
    fp = script_path.joinpath('test_zstd.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_invalid_compression():
    ...
    fp = script_path.joinpath('test_bad_comp.cfdb')
    with pytest.raises(ValueError):
...
def test_read_only_no_write():
    ...
    fp = script_path.joinpath('test_ro.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
    lon = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_duplicate_variable_name():
    ...
    fp = script_path.joinpath('test_dup.cfdb')
    with open_dataset(fp, flag='n') as ds:
        ds.create.coord.lat(data=ind_lat_data[:10], chunk_shape=(10,))
...
def test_duplicate_axis():
    ...
    fp = script_path.joinpath('test_dup_axis.cfdb')
    with open_dataset(fp, flag='n') as ds:
        ds.create.coord.lat(data=ind_lat_data[:10], chunk_shape=(10,))
...
def test_multiple_data_vars():
    ...
    fp = script_path.joinpath('test_multi_dv.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_integer_coordinate():
    ...
    fp = script_path.joinpath('test_int_coord.cfdb')
...
def test_units():
    ...
    fp = script_path.joinpath('test_units.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_units_read_only():
    ...
    fp = script_path.joinpath('test_units_ro.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_reopen_dataset():
    ...
    fp = script_path.joinpath('test_reopen.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_open_write_modify():
    ...
    fp = script_path.joinpath('test_w_flag.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
    lon = np.linspace(0, 4.9, 50, dtype='float32')
...
def test_empty_dataset_repr():
    ...
    fp = script_path.joinpath('test_empty.cfdb')
    with open_dataset(fp, flag='n') as ds:
        rep = repr(ds)
...
def test_empty_coord():
    ...
    fp = script_path.joinpath('test_empty_coord.cfdb')
    with open_dataset(fp, flag='n') as ds:
...
def test_copy_include_data_vars():
    ...
    fp2 = script_path.joinpath('test_copy_dst.cfdb')
    lat = np.linspace(0, 4.9, 50, dtype='float32')
    t = np.linspace(0, 4, 5, dtype='datetime64[D]')
