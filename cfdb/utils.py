...
default_dtype_params = {
    ...
    'vorticity': {'precision': 5, 'name': 'float32', 'offset': -0.300001, 'dtype_encoded': 'uint16', 'fillvalue': 0},
    'vertical_velocity': {'precision': 2, 'name': 'float32', 'offset': -50.01, 'dtype_encoded': 'uint16', 'fillvalue': 0},
    'sensible_heat_flux': {'precision': 1, 'name': 'float32', 'offset': -300.1, 'dtype_encoded': 'uint16', 'fillvalue': 0},
    'moisture_flux': {'precision': 6, 'name': 'float32', 'offset': -0.010001, 'dtype_encoded': 'uint16', 'fillvalue': 0},
    'albedo': {'precision': 3, 'name': 'float32', 'offset': -0.001, 'dtype_encoded': 'uint16', 'fillvalue': 0},
    'emissivity': {'precision': 3, 'name': 'float32', 'offset': -0.001, 'dtype_encoded': 'uint16', 'fillvalue': 0},
    'land_use_modis': {'name': 'uint8'},
...
default_var_params = {
    ...
    'vertical_velocity': {'name': 'vertical_velocity'},
    'sensible_heat_flux': {'name': 'sensible_heat_flux'},
    'moisture_flux': {'name': 'moisture_flux'},
    'albedo': {'name': 'albedo'},
    'emissivity': {'name': 'emissivity'},
    'land_use_modis': {'name': 'land_use_modis'},
...
default_attrs = dict(
    ...
    land_use_modis={
        ...
        'flag_meanings': 'evergreen_needleleaf_forests evergreen_broadleaf_forests deciduous_needleleaf_forests deciduous_broadleaf_forests mixed_forests closed_shrublands open_shrublands woody_savannas savannas grasslands permanent_wetlands croplands urban_and_built_up cropland_natural_vegetation_mosaics permanent_snow_and_ice barren water_bodies wooded_tundra mixed_tundra barren_tundra lakes',
        },
    point={
